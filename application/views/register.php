...
<div class="container">
	<form class="form-container card center-block" method="post" action="<?php echo base_url('LoginScreen/register'); ?>">
	    ...
	    <span class="register-btn"><a href="<?php echo base_url('LoginScreen/'); ?>">Login</a></span>
  	</form>
</div>
